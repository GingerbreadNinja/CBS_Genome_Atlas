...
def process_one_genome(accession, version):
    ...
    call(["xmsub", "-l", "mem=4gb,walltime=3600,procs=8,partition=cge-cluster", "-de", "-ro", logging_dir + accession + "_" + job_uuid + ".log", "-re", logging_dir + accession + "_" + job_uuid + ".out", "-N", accession + "_" + str(version) + "_" + job_uuid, "-r", "y", "make -i -k", "ACCESSION=" + accession, "VERSION=" + str(version), "JOB_UUID=" + job_uuid])
